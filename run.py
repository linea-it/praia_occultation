...
if __name__ == "__main__":
    ...
    dir_inputs = os.environ.get("DIR_INPUTS")

    name = "1999RB216"

    datesFile = os.path.join(dir_inputs, "dates.txt")
    bspObject = os.path.join(dir_inputs, "1999RB216.bsp")
    bspPlanets = os.path.join(dir_inputs, "de435.bsp")
    leapSec = os.path.join(dir_inputs, "naif0012.tls")
    startDate = '2018-JAN-01'
    finalDate = '2018-DEC-31 23:59:01'
    step = '60'
    ...
    shutil.copy(leapSec, current_dir)
